...
RUN	echo "deb http://ftp.tw.debian.org/debian/ stable main contrib non-free" > /etc/apt/sources.list \
	&& echo "deb-src http://ftp.tw.debian.org/debian/ stable main contrib non-free" >> /etc/apt/sources.list \
	&& echo "deb http://ftp.tw.debian.org/debian/ stable-updates main contrib non-free" >> /etc/apt/sources.list \
	&& echo "deb-src http://ftp.tw.debian.org/debian/ stable-updates main contrib non-free" >> /etc/apt/sources.list \
